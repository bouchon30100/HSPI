...
#Region "Tables"
    ...
    Public Class HTMLTable
        ...
        Public Sub New(ByVal border As Integer, _
                                    Optional ByRef CellSpacing As Short = -1, _
                                    Optional ByRef TableWidthPercent As Short = -1, _
                                    Optional ByVal Style As String = "", _
                                    Optional ByVal ClassName As String = "", _
        ...
        Public Sub addCell(html As String, ByRef Class_name As String, _
                                   ByRef colspan As Short, _
                                   Optional ByVal urlBackground As String = "", _
                                   Optional ByVal align As HTML_Align = 0, _
                                   Optional ByVal nowrap As Boolean = False, _
        ...
        Public Function GetHTML() As String
            ...
            For Each r As HTMLTableRow In rows
                ...
                If first Then
                    r.Cells(0) = New HTMLTableCell(" ", "", 1, "../images/default/no.png", HTML_Align.CENTER, False, 36, 21, "")
                    For i As Integer = 1 To r.Cells.Count - 2
                        If i = 1 AndAlso r.Cells.Count - 2 = 1 Then
                            r.Cells(i) = New HTMLTableCell("<b>" & r.Cells(i)._html & "</b>", "", maxColonne - 2, "../images/default/n.png", HTML_Align.CENTER, False, 36, 0, "")
                        Else
                            r.Cells(i) = New HTMLTableCell("<b>" & r.Cells(i)._html & "</b>", "", r.Cells(i)._colspan, "../images/default/n.png", HTML_Align.CENTER, False, 36, 0, "")
                        End If
                    Next
                    r.Cells(r.Cells.Count - 1) = New HTMLTableCell(" ", "", 1, "../images/default/ne.png", HTML_Align.CENTER, False, 36, 23, "")
                    first = False
                Else
