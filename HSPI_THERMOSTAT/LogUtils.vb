...
Public Module LogUtils
    ...
    Public Sub Log(ByVal Message As String, Optional ByVal TypeMessage As MessageType = MessageType.Normal)

        '***************************************************************************
        '*   Ajout les lignes suivantes dans WebConfig sous postBackProc
        '*                  Case "LogLevel"
        '*                  hs.SaveINISetting("param", "logLevel", parts("LogLevel"), INIFILE)
        '****************************************************************************
        Select Case hs.GetINISetting("param", "logLevel", 0, INIFILE)
            Case LogLevel.Debug
                If TypeMessage = LogLevel.Debug Then
            ...
            Case LogLevel.Normal
                If TypeMessage = LogLevel.Normal Then
                    hs.WriteLog(IFACE_NAME, Message)
                End If
