...
#If 0 Then
    ...
    End Function
#End If
    Friend Function AddNavTransLink(ByRef url As String, ByRef label As String,
                                     Optional ByVal bSelected As Boolean = False,
    ...
    Public Function HTML_StartCell(ByRef Class_name As String,
        ...
        If urlBackground IsNot Nothing AndAlso Not String.IsNullOrEmpty(urlBackground.Trim) Then
            TotalStyle &= " background-image:url(" & urlBackground & ");"
        End If
        ...
        If CellWidth > 0 Then
            If Not String.IsNullOrEmpty(TotalStyle.Trim) Then
                ...
                End If
            End If
            TotalStyle &= " width:" & CellWidth.ToString & "px;"
        End If
    ...
    Function html_TableRow(txt As String, Optional ByVal ClassName As String = "",
                                  Optional ByVal Style As String = "",
                                  Optional ByVal Align As HTML_Align = 0,
                                  Optional ByVal BackColor As String = "",
                                  Optional ByVal VertAlign As HTML_VertAlign = 0) As String
        Dim s As New StringBuilder
        s.Append(HTML_StartRow("", Style, Align, BackColor, VertAlign))
        s.Append(txt)
        s.Append(HTML_EndRow)
        Return s.ToString()
    End Function


    'Public Const HTML_StartRow As String = "<tr>"
    Public Function HTML_StartRow(Optional ByVal ClassName As String = "",
                                  Optional ByVal Style As String = "",
                                  Optional ByVal Align As HTML_Align = 0,
                                  Optional ByVal BackColor As String = "",
                                  Optional ByVal VertAlign As HTML_VertAlign = 0) As String
    ...
    Function html_TableCell(txt As String, ByRef Class_name As String,
                                   ByRef colspan As Short,
                                   Optional ByVal urlBackground As String = "",
                                   Optional ByVal align As HTML_Align = 0,
                                   Optional ByVal nowrap As Boolean = False,
                                   ...
                                   Optional ByVal VertAlign As HTML_VertAlign = 0) As String
        Dim s As New StringBuilder
        s.Append(HTML_StartCell(Class_name, colspan, urlBackground, align, nowrap, RowHeight, CellWidth, Style, VertAlign))
        s.Append(txt)
        s.Append(HTML_EndCell)
        Return s.ToString()
    End Function

    Public Function html_Table(txt As String, ByVal border As Integer,
        ...
        Dim s As New StringBuilder
        s.Append(HTML_StartTable(border, CellSpacing, TableWidthPercent, Style, ClassName, Align, CellPadding, TableWidthPixels))
        s.Append(txt)
        s.Append(HTML_EndTable)
        Return s.ToString()
    End Function


    Public Function HTML_StartTable(ByVal border As Integer,
                                    Optional ByRef CellSpacing As Short = -1,
                                    Optional ByRef TableWidthPercent As Short = -1,
                                    Optional ByVal Style As String = "",
                                    Optional ByVal ClassName As String = "",
    ...
    Public Function AddLink(ByRef ref As String,
                            ByRef label As String,
                            Optional ByRef image As Object = Nothing,
                            Optional ByRef Width As Integer = 0,
                            Optional ByRef Height As Integer = 0,
    ...
    Public Function AddNavLink(ByRef ref As String, ByRef label As String,
                               Optional ByVal bSelected As Boolean = False,
    ...
    Public Function AddNavLinkPlugin(ByRef ref As String, ByRef label As String,
       Optional ByVal bSelected As Boolean = False,
       Optional ByVal AltText As String = "") As Object
        Dim st As String = ""
        On Error Resume Next
...
#End If
    ...
    Public Function FormCheckBox(ByRef label As String, ByRef name As String, ByRef Value As String,
    ...
    Public Function FormCheckBoxEx(ByRef label As String, ByRef name As String, ByRef Value As String,
     ByRef checked As Boolean, Optional ByRef PrevNNL As Boolean = False,
    ...
    Public Function FormRadio(ByRef label As String, ByRef name As String, ByRef Value As String,
    ...
    Public Function FormRadioEx(ByRef label As String, ByRef name As String,
                                ByRef Value As String, ByRef checked As Boolean,
                                Optional ByRef PrevNNL As Boolean = False,
                                Optional ByRef NNL As Boolean = False,
    ...
    ' rjh 2.2.0.2
    Public Function FormLinkButton(ByRef URL As String,
                                   ByRef label As String,
    ...
    Public Function HTML_WrapSpan(ByVal id As String, ByVal wraptext As String, Optional ByVal bdisplay As Boolean = False,
    ...
    Public Function FormConfButton(ByRef Name As String, ByRef id As String, ByRef Source As String,
     ByRef alt_title As String, Optional ByVal sel As Boolean = False,
...
#Region "Tables"
    ...
    Public Class HTMLTable
        ...
        Public Sub New(ByVal border As Integer,
                                    Optional ByRef CellSpacing As Short = 0,
                                    Optional ByRef TableWidthPercent As Short = -1,
                                    Optional ByVal Style As String = "",
                                    Optional ByVal ClassName As String = "",
                                    Optional ByVal Align As HTML_TableAlign = 0,
                                    Optional ByVal CellPadding As Short = 0,
        ...
        Public Sub addRow(Optional ByVal ClassName As String = "",
            ...
            If (rows.Count > 0) Then
                Me.addCell(New HTMLTableCell(" ", "", 1, "../images/default/e.png", HTML_Align.CENTER, False, 0, 23))
                Me.rows.AddLast(New HTMLTableRow())
                Me.GetLastTableRow.addCell(New HTMLTableCell(" ", "", 1, "../images/default/o.png", HTML_Align.CENTER, False, 0, 21))
                Me.GetLastTableRow.addCell(New HTMLTableCell(" ", "", 1, "../images/default/c.png", HTML_Align.CENTER, False, 3))
                Me.GetLastTableRow.addCell(New HTMLTableCell(" ", "", 1, "../images/default/e.png", HTML_Align.CENTER, False, 0, 23))
            End If
            If (rows.Count = 2) Then
                Me.rows.AddLast(New HTMLTableRow())
                Me.GetLastTableRow.addCell(New HTMLTableCell(" ", "", 1, "../images/default/o.png", HTML_Align.CENTER, False, 0, 21))
                Me.GetLastTableRow.addCell(New HTMLTableCell(" ", "", 1, "../images/default/c.png", HTML_Align.CENTER, False, 12))
                Me.GetLastTableRow.addCell(New HTMLTableCell(" ", "", 1, "../images/default/e.png", HTML_Align.CENTER, False, 0, 23))
            ...
            Me.addCell(New HTMLTableCell(" ", "", 1, "../images/default/o.png", HTML_Align.CENTER, False, 0, 21))
        ...
        Public Sub addEmptyRow(RowHeight As Integer, Optional ByVal urlBackground As String = "")
            Me.addRow()
            Me.addCell("", "", 1, urlBackground, HTML_Align.CENTER, False, RowHeight)
        End Sub

        Public Sub addCell(html As String, ByRef Class_name As String,
                                   ByRef colspan As Short,
                                   Optional ByVal urlBackground As String = "../images/default/c.png",
                                   Optional ByVal align As HTML_Align = 0,
                                   Optional ByVal nowrap As Boolean = False,
                                   Optional ByVal RowHeight As Integer = 0,
                                   Optional ByVal CellWidth As Integer = 0,
            ...
            Dim cell As New HTMLTableCell(html, Class_name, colspan, urlBackground, align, nowrap, RowHeight, CellWidth, Style, VertAlign)
            nbColonne += colspan
        ...
        Public Sub addEmptyCell(width As Integer)
            Me.addCell(New HTMLTableCell("", "", 1, "../images/default/c.png", HTML_Align.CENTER, False, 0, width))
        End Sub
        ...
        Public Function GetHTML() As String
            ...
            'Dim cell As HTMLTableCell = New HTMLTableCell(" ", "", 1, "../images/default/no.png", HTML_Align.CENTER, False, 36, 21, "")
            'row.addCell(cell)

            'cell = New HTMLTableCell(" ", "", maxColonne - 2, "../images/default/n.png", HTML_Align.CENTER, False, 36, 0, "")
            'row.addCell(cell)
            'cell = New HTMLTableCell(" ", "", 1, "../images/default/ne.png", HTML_Align.CENTER, False, 36, 23, "")
            'row.addCell(cell)
            'Me.rows.AddFirst(row)


            Me.addRow()
            Me.GetLastTableRow().Cells.RemoveAt(0)
            Me.addCell(" ", "", 1, "../images/default/so.png", HTML_Align.CENTER, False, 31, 21, "")
            Me.addCell(" ", "", maxColonne - 2, "../images/default/s.png", HTML_Align.CENTER, False, 31, 0, "")
            Me.addCell(" ", "", 1, "../images/default/se.png", HTML_Align.CENTER, False, 31, 23, "")
            Dim first As Boolean = True
            For Each r As HTMLTableRow In rows

                If first Then
                    r.Cells(0) = New HTMLTableCell(" ", "", 1, "../images/default/no.png", r.Cells(0)._align, False, 36, 21, "")
                    For i As Integer = 1 To r.Cells.Count - 2
                        If i = 1 AndAlso r.Cells.Count - 2 = 1 Then
                            r.Cells(i) = New HTMLTableCell("<b>" & r.Cells(i)._html & "</b>", "", maxColonne - 2, "../images/default/n.png", r.Cells(i)._align, False, 36, 0, "")
                        Else
                            r.Cells(i) = New HTMLTableCell("<b>" & r.Cells(i)._html & "</b>", "", r.Cells(i)._colspan, "../images/default/n.png", r.Cells(i)._align, False, 36, 0, "")
                        End If
                    Next
                    r.Cells(r.Cells.Count - 1) = New HTMLTableCell(" ", "", 1, "../images/default/ne.png", r.Cells(r.Cells.Count - 1)._align, False, 36, 23, "")
                    first = False
                Else
                    If r.Cells.Count = 3 Then
                        r.Cells(1) = New HTMLTableCell(r.Cells(1)._html, "", maxColonne - 2, r.Cells(1)._urlBackground, r.Cells(1)._align, False, r.Cells(1)._RowHeight, 0, "")

                    End If
                End If

                For Each c As HTMLTableCell In r.Cells
                    r.html += html_TableCell(c._html, c._Class_name, c._colspan, c._urlBackground, c._align, c._nowrap, c._RowHeight, c._CellWidth, c._Style, c._VertAlign)
                Next
                html += html_TableRow(r.html, r._ClassName, r._Style, r._Align, r._BackColor, r._VertAlign)
            Next


            Return html_Table(html, _border, _CellSpacing, _TableWidthPercent, _Style, _ClassName, _Align, _CellPadding, _TableWidthPixels)
        End Function
