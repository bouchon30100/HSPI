...
Module Main
    Public WithEvents client As IScsServiceClient(Of IHSApplication)
    Dim WithEvents clientCallback As IScsServiceClient(Of IAppCallbackAPI)

    Private host As IHSApplication
    Private gAppAPI As HSPI = Nothing

    Public Sub Main()
        Dim sIp As String = "127.0.0.1"
        Dim argv As ObjectModel.ReadOnlyCollection(Of String)
