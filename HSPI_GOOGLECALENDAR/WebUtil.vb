...
#End If
    ...
    Function html_TableRow(txt As String, Optional ByVal ClassName As String = "", _
                                  Optional ByVal Style As String = "", _
                                  Optional ByVal Align As HTML_Align = 0, _
    ...
    Function html_TableCell(txt As String, ByRef Class_name As String, _
                                   ByRef colspan As Short, _
                                   Optional ByVal urlBackground As String = "", _
                                   Optional ByVal align As HTML_Align = 0, _
                                   Optional ByVal nowrap As Boolean = False, _
    ...
    Public Function html_Table(txt As String, ByVal border As Integer, _
...
#Region "Tables"
    ...
    Public Class HTMLTable
        ...
        Public Sub addRow(Optional ByVal ClassName As String = "", _
                                  Optional ByVal Style As String = "", _
                                  Optional ByVal Align As HTML_Align = 0, _
                                  Optional ByVal BackColor As String = "", _
    ...
    Public Class HTMLTableRow
        ...
        Public Sub New(Optional ByVal ClassName As String = "", _
                                  Optional ByVal Style As String = "", _
                                  Optional ByVal Align As HTML_Align = 0, _
                                  Optional ByVal BackColor As String = "", _
                                  Optional ByVal VertAlign As HTML_VertAlign = 0)
    ...
    Public Class HTMLTableCell
        ...
        Public Sub New(html As String, ByRef Class_name As String, _
                                   ByRef colspan As Short, _
                                   Optional ByVal urlBackground As String = "", _
                                   Optional ByVal align As HTML_Align = 0, _
                                   Optional ByVal nowrap As Boolean = False, _
