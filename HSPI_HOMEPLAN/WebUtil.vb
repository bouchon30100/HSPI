...
#End If
    ...
    Public Function HTML_Graphic(ByVal file As String, ByVal Class_name As String, ByVal width As Integer, ByVal height As Integer) As String
        Dim st As String = ""
        If width = 0 Then
            st = "<img src=""" & file & """ "
        Else
    ...
    Public Function HTML_StartCell(ByRef Class_name As String,
                                   ...
                                   Optional ByVal ColorBackground As String = "",
        ...
        If ColorBackground IsNot Nothing AndAlso Not String.IsNullOrEmpty(ColorBackground.Trim) Then
            TotalStyle &= " background-color:" & ColorBackground & ";"
        End If
    ...
    Function html_TableCell(txt As String, ByRef Class_name As String,
                                   ...
                                   Optional ByVal VertAlign As HTML_VertAlign = 0) As String
        Dim s As New StringBuilder
        s.Append(HTML_StartCell(Class_name, colspan, urlBackground, ColorBackground, align, nowrap, RowHeight, CellWidth, Style, VertAlign))
        s.Append(txt)
    ...
    Public Function html_Table(txt As String, ByVal border As Integer,
                                    ...
                                    Optional ByVal urlBackground As String = "") As String
        Dim s As New StringBuilder
        s.Append(HTML_StartTable(border, CellSpacing, TableWidthPercent, Style, ClassName, Align, CellPadding, TableWidthPixels, urlBackground))
        s.Append(txt)
...
#Region "Tables"
    ...
    Public Class HTMLTableDiv

        Public rows As New LinkedList(Of _HTMLTableRow)
        Dim _Content = ""
        Dim _border As Integer = 0
        Dim _CellSpacing As Short = 0
        Dim _TableWidth As Short = -1
        ...
        Private _TableWidthPercent As Short = -1
        Private _Style As String = ""
        Private _ClassName As String = ""

        Public Sub New(Optional ByVal id As String = "",
                        Optional ByVal title As String = "",
                       Optional ByVal theme As String = "Default")
            _Align = HTML_Align.CENTER

            Me.addRow(_Align, "")
            Me.addCell(New _HTMLTableCell(" ", 1, "../images/" + theme + "/no.png", _Align, False, 36, 21))
            Me.addCell(New _HTMLTableCell("<b>" + title + "</b>", 1, "../images/" + theme + "/n.png", _Align, False, 36, 0))
            Me.addCell(New _HTMLTableCell(" ", 1, "../images/" + theme + "/ne.png", _Align, False, 36, 23))

            Me.addRow(_Align, "")
            Me.addCell(New _HTMLTableCell(" ", 1, "../images/" + theme + "/o.png", _Align, False, 0, 21))
            Me.addCell(New _HTMLTableCell("<div id=" + id + " name=" + id + ">%Content%</div>", 1, "../images/" + theme + "/c.png", _Align, False, 3))
            Me.addCell(New _HTMLTableCell(" ", 1, "../images/" + theme + "/e.png", _Align, False, 0, 23))


            Me.addRow(_Align, "")
            Me.addCell(" ", 1, "../images/" + theme + "/so.png", _Align, False, 31, 21)
            Me.addCell(" ", 1, "../images/" + theme + "/s.png", _Align, False, 31, 0)
            Me.addCell(" ", 1, "../images/" + theme + "/se.png", _Align, False, 31, 23)
        End Sub



        Public Sub addRow(Optional ByVal Align As HTML_Align = 0,
                                  Optional ByVal BackColor As String = "")

            Me.rows.AddLast(New _HTMLTableRow(Align, ""))

        End Sub


        Public Sub addCell(html As String, ByRef colspan As Short,
                                   Optional ByVal urlBackground As String = "",
                                   Optional ByVal ColorBackground As String = "",
                                   Optional ByVal align As HTML_Align = 0,
                                   Optional ByVal nowrap As Boolean = False,
            ...
            Dim cell As New _HTMLTableCell(html, colspan, urlBackground, ColorBackground, align, nowrap, RowHeight, CellWidth, VertAlign)
            nbColonne += colspan
            GetLastTableRow().addCell(cell)
        End Sub

        Public Sub addCell(cell As _HTMLTableCell)
            GetLastTableRow().addCell(cell)
        End Sub


        Public Function GetLastTableRow() As _HTMLTableRow
            Return rows.Last.Value
        End Function

        Public Function GetHTML(ByVal content As String) As String

            Me._Content = content

            Dim html As String = ""
            Dim first As Boolean = True
            For Each r As _HTMLTableRow In rows

                For Each c As _HTMLTableCell In r.Cells
                    c._html = c._html.Replace("%Content%", Me._Content)
                    r.html += html_TableCell(c._html, "", c._colspan, c._urlBackground, c._ColorBackground, c._align, c._nowrap, c._RowHeight, c._CellWidth)
                Next
                html += html_TableRow(r.html, r._ClassName, r._Style, r._Align, r._BackColor, r._VertAlign)
            Next


            Return html_Table(html, _border, _CellSpacing, _TableWidthPercent, _Style, _ClassName, _Align, _CellPadding)
        End Function


    End Class

    Public Class _HTMLTableRow
        Public html As String = ""
        Public Cells As New List(Of _HTMLTableCell)
        ...
        Public Sub New(Optional ByVal Align As HTML_Align = 0,
                                  Optional ByVal BackColor As String = "")
