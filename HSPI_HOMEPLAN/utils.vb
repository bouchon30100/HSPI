...
Module utils
    Public IFACE_NAME As String = "HOMEPLAN"
    ...
    Public Const INIFILE As String = "HSPI_HOMEPLAN.ini"
    Public Const INIFILE_saison As String = "HSPI_RESSENTI_AUTOMNE.ini"
    Public Const INIFILE_ETE As String = "HSPI_RESSENTI_ETE.ini"
    Public Const INIFILE_PRINTEMPS As String = "HSPI_RESSENTI_PRINTEMPS.ini"
    Public Const INIFILE_HIVERS As String = "HSPI_RESSENTI_HIVERS.ini"
    ...
    Public Sub Log(ByVal Message As String, Optional ByVal Log_Level As LogLevel = LogLevel.Normal)
        ...
        If Log_Level = LogLevel.Debug Then
            If IO.Directory.Exists(gEXEPath & "\Debug Logs") Then
                IO.File.AppendAllText(gEXEPath & "\Debug Logs\MyPlug.log", Now.ToString & " ~ " & Message & vbCrLf)
            ElseIf IO.Directory.Exists(gEXEPath & "\Logs") Then
                IO.File.AppendAllText(gEXEPath & "\Logs\MyPlug.log", Now.ToString & " ~ " & Message & vbCrLf)
            Else
                IO.File.AppendAllText(gEXEPath & "\MyPlug.log", Now.ToString & " ~ " & Message & vbCrLf)
            End If
        End If
    End Sub
